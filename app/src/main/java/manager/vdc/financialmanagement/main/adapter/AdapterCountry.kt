...
import manager.vdc.financialmanagement.databinding.ItemCountryBinding
import manager.vdc.financialmanagement.databinding.ItemCountryConversionBinding
...
class AdapterCountry(
    ...
    override fun onBindViewHolder(
        holder: AdapterCountry.ViewHolder,
        position: Int,
    ) {
