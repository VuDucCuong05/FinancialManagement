package manager.vdc.financialmanagement.main.base
...
import manager.vdc.financialmanagement.main.inf.MyCallback
import manager.vdc.financialmanagement.main.model.m.ConvertXML
...
abstract class BaseFragment : Fragment() {
    ...
    fun shareFile(file: File) {
        val contentUri = FileProvider.getUriForFile(requireActivity(), "manager.vdc.financialmanagement.fileprovider", file)
